--
-- File generated with SQLiteStudio v3.0.7 on Tue Oct 11 17:23:37 2016
--
...
CREATE TABLE measurements (
    ...
    used_cpu_cores INTEGER NOT NULL
                           CONSTRAINT default_used_cpu_cores DEFAULT (1),
    ...
    bidir          BOOLEAN NOT NULL
                           DEFAULT FALSE,
    control_nfpa   BOOLEAN CONSTRAINT control_nfpa_contraint NOT NULL
                           DEFAULT FALSE,
    FOREIGN KEY (
        cpu
    )
...
CREATE VIEW measurements_view_v2 AS
    SELECT measurements.id,
           ...
           measurements.control_nfpa,
           measurements.used_cpu_cores,
