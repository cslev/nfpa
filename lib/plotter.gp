...
p INPUT_DATA u 1:2:2:2:xtic(1) with yerrorlines pt 7 ps 3 lw 10 lt 1 title "Theoretical", \
  INPUT_DATA u 1:4:3:5:xtic(1) with yerrorlines pt 8 ps 1 lw 6 lt 2 title "Sent-".TR1, \
  INPUT_DATA u 1:7:6:8:xtic(1) with yerrorlines pt 10 ps 1 lw 6 lt 3 title "Recv-".TR1


### MISSED PACKETS ###
#Setting output
set output OUTPUT_BASENAME."miss_".PPS_UNIT."pps.eps"
p INPUT_DATA u 1:10:9:11:xtic(1) with yerrorlines pt 10 ps 2 lw 6 lt 4 title "Miss-".TR1
...
#this actually puts out the results
p INPUT_DATA u 1:13:12:14:xtic(1) with yerrorlines pt 8 ps 1 lw 6 lt 2 title "Sent-".TR1, \
  INPUT_DATA u 1:16:15:17:xtic(1) with yerrorlines pt 10 ps 1 lw 6 lt 3 title "Recv-".TR1
...
p INPUT_DATA u 1:19:18:20:xtic(1) with yerrorlines pt 10 ps 1 lw 6 lt 4 title "Diff-".TR1
